 ...
 * Функция getGift: () => Int возвращает размер подарка (при тестировании передается на вход программе),
 * а также выводит на экран фразу "The gift is received".
 *
